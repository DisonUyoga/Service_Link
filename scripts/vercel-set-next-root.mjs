/**
 * Ensure Vercel project builds only the Next.js app (web/).
 * Usage: VERCEL_TOKEN=... node scripts/vercel-set-next-root.mjs
 */
...
if (!res.ok) {
  console.error("PATCH_FAILED", res.status, text.slice(0, 500));
  process.exit(1);
}
